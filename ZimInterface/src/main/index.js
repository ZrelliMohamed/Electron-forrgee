...
app.whenReady().then(async() => {
  ...
  handleArticleIPC(mainWindow,createNewOnglet);
...
function createNewOnglet(appToRender,width,height,title) {
  // Create the browser window.
let newWindow = new BrowserWindow({
   ...
   resizable: false,                     // ✅ pas de redimensionnement
    minimizable: false,                   // ✅ enlève bouton réduire
    maximizable: false,                   // ✅ enlève bouton agrandir
      icon:title === "Confirmation de suppression"? join(__dirname, '../../resources/Pngtree.png') :"",
    webPreferences: {
      preload: join(__dirname, '../preload/index.mjs'),
      sandbox: false
    }
