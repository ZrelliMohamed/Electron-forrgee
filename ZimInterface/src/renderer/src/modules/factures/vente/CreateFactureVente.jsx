...
import GetClient from './CreateFactureHelper/GetClient.jsx';
import FacArticles from './CreateFactureHelper/FacArticles.jsx';
import img from '../../../assets/images/ZimLogo.png';
import { useNavigate, useLocation } from 'react-router-dom';

export default function CreateFactureVente() {
    ...
    if ((exonore && rules.attestation_num != 0 && rules.date_Attes !== null && rules.BCN !== 0 && rules.date_BC !== null) || exonore === false) {
      if (filteredArticles.length > 0) {
          ...
          window.electron.ipcRenderer.on('Facture:create:succes', (event, data) => {
            navigate(`/factures/vente/PrintFac`, {
              state: {
                articles: articles,
